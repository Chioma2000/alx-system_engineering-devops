...
Create the answer file 2-setupdatadog which has the dashboardid on the first line. Note: in order to get the id of your dashboard, you may need to use Datadog’s API
